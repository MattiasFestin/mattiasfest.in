...
- The loss is cross-entropy `$= -\log P(\text{true next token})$`, the gradient at the head is `$g = p - y$`, and it flows backward exactly as in Part 4. Zero new math.
